...
int Game_Loop(Window *window, const char *server_hostname,
              const char *wish_name) {
...

  {
    ...
    pausemenu_ids[PAUSEMENU_DISCONNECT_BTN] =
        Menu_add_button(&pause_menu, disconnect_btn);
  }
