...
void Vector_delete(Vector *vec) { free(vec->array); }
...
void *Vector_get_last(Vector *vec) { return Vector_get(vec, vec->num - 1); }

void *Vector_get_first(Vector *vec) { return Vector_get(vec, 0); }
